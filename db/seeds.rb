...
Trip.create!(start_date: Date.new(2020, 5, 28), end_date: Date.new(2020, 6, 12), location: 'New York City', status: 'confirmed', latitude: 40.7128, longitude: -74.0060, user_id: 14)
Trip.create!(start_date: Date.new(2020, 6, 19), end_date: Date.new(2020, 6, 30), location: 'Barcelona', status: 'confirmed', latitude: 41.3851, longitude: 2.1734, user_id: 11)
Trip.create!(start_date: Date.new(2020, 6, 28), end_date: Date.new(2020, 7, 8), location: 'Seoul', status: 'confirmed', latitude: 37.5665, longitude: 126.9780, user_id: 6)
Trip.create!(start_date: Date.new(2020, 7, 18), end_date: Date.new(2020, 7, 28), location: 'Los Angeles', status: 'confirmed', latitude: 34.0522, longitude: -118.2437, user_id: 6)
Trip.create!(start_date: Date.new(2020, 7, 20), end_date: Date.new(2020, 7, 25), location: 'Barcelona', status: 'confirmed', latitude: 41.3851, longitude: 2.1734, user_id: 14)
Trip.create!(start_date: Date.new(2020, 7, 21), end_date: Date.new(2020, 7, 29), location: 'Los Angeles', status: 'confirmed', latitude: 34.0522, longitude: -118.2437, user_id: 11)
Trip.create!(start_date: Date.new(2020, 8, 2), end_date: Date.new(2020, 8, 13), location: 'Seoul', status: 'saved', latitude: 37.5665, longitude: 126.9780, user_id: 6)
Trip.create!(start_date: Date.new(2020, 8, 2), end_date: Date.new(2020, 8, 9), location: 'New York City', status: 'saved', latitude: 40.7128, longitude: -74.0060, user_id: 14)
...
Trip.create!(start_date: Date.new(2020, 9, 18), end_date: Date.new(2020, 9, 22), location: 'Barcelona', status: 'confirmed', latitude: 41.3851, longitude: 2.1734, user_id: 12)
Trip.create!(start_date: Date.new(2020, 9, 21), end_date: Date.new(2020, 9, 30), location: 'Los Angeles', status: 'confirmed', latitude: 34.0522, longitude: -118.2437, user_id: 5)
Trip.create!(start_date: Date.new(2020, 9, 28), end_date: Date.new(2020, 10, 8), location: 'Los Angeles', status: 'confirmed', latitude: 34.0522, longitude: -118.2437, user_id: 7)
...
Ketchup.create!(start_date: DateTime.new(2020, 2, 24, 18, 00, 0), end_date: DateTime.new(2020, 2, 24, 20, 15, 0), message: 'Craving for some Korean meat! Vamos?', location: 'Gombawi', status: 'pending', latitude: 37.510203, longitude: 127.055203, user_id: 23, trip_id: 6)
Ketchup.create!(start_date: DateTime.new(2020, 6, 1, 16, 30, 0), end_date: DateTime.new(2020, 6, 1, 17, 00, 0), message: 'Quick afternoon coffee before my afternoon meeting in Brooklyn', location: 'Starbucks', status: 'pending', latitude: 40.748985, longitude: -73.992362, user_id: 10, trip_id: 7)
Ketchup.create!(start_date: DateTime.new(2020, 6, 8, 12, 30, 0), end_date: DateTime.new(2020, 6, 8, 13, 45, 0), message: 'Claire will be my guide to show me around one of the iconic place in the world', location: 'Times square', status: 'pending', latitude: 40.757970, longitude: -73.985549, user_id: 8, trip_id: 7)
Ketchup.create!(start_date: DateTime.new(2020, 6, 8, 19, 00, 0), end_date: DateTime.new(2020, 6, 8, 23, 00, 0), message: 'Long and relaxing dinner at a restaurant with superb view', location: 'Maiella', status: 'pending', latitude: 40.747190, longitude: -73.956690, user_id: 9, trip_id: 7)
Ketchup.create!(start_date: DateTime.new(2020, 6, 29, 9, 00, 0), end_date: DateTime.new(2020, 6, 29, 11, 30, 0), message: 'Morning hike in the mountain located in the middle of Seoul with great view', location: 'Namsan Mountain Park', status: 'confirmed', latitude: 37.550815, longitude: 126.991211, user_id: 19, trip_id: 9)
Ketchup.create!(start_date: DateTime.new(2020, 7, 1, 18, 00, 0), end_date: DateTime.new(2020, 7, 1, 19, 30, 0), message: 'Short dinner to ketchup with my man', location: 'Maple Tree House', status: 'confirmed', latitude: 37.535047, longitude: 126.993882, user_id: 24, trip_id: 9)
Ketchup.create!(start_date: DateTime.new(2020, 7, 19, 13, 00, 0), end_date: DateTime.new(2020, 7, 19, 16, 00, 0), message: 'Long lunch at Mexican restaurant in Long Beach', location: 'Tequila Jack\'s Restaurant and Cantina', status: 'confirmed', latitude: 33.761056, longitude: -118.190132, user_id: 13, trip_id: 10)
Ketchup.create!(start_date: DateTime.new(2020, 7, 20, 12, 00, 0), end_date: DateTime.new(2020, 7, 20, 14, 15, 0), message: 'Going to my favorite place in the world and walking around Hollywood', location: 'In-N-Out Burger', status: 'confirmed', latitude: 34.098220, longitude: -118.341672, user_id: 16, trip_id: 10)
Ketchup.create!(start_date: DateTime.new(2020, 7, 22, 12, 30, 0), end_date: DateTime.new(2020, 7, 22, 13, 00, 0), message: 'Quick coffee with Ellyn to just say hi', location: 'Onna Coffee', status: 'confirmed', latitude: 41.398098, longitude: 2.159659, user_id: 1, trip_id: 11)
Ketchup.create!(start_date: DateTime.new(2020, 7, 22, 21, 00, 0), end_date: DateTime.new(2020, 7, 22, 23, 00, 0), message: 'Dinner with Prima at traditional Catalan restaurant', location: 'Goliard', status: 'confirmed', latitude: 41.399828, longitude: 2.160637, user_id: 4, trip_id: 11)
Ketchup.create!(start_date: DateTime.new(2020, 7, 24, 15, 00, 0), end_date: DateTime.new(2020, 7, 24, 16, 00, 0), message: 'Enjoying the sun and walk on the beach', location: 'Platja del Bogatell', status: 'pending', latitude: 41.394380, longitude: 2.206989, user_id: 2, trip_id: 11)
Ketchup.create!(start_date: DateTime.new(2020, 7, 24, 18, 00, 0), end_date: DateTime.new(2020, 7, 24, 19, 30, 0), message: 'A hike in the park with my old friend', location: 'Runyon Canyon Park', status: 'pending', latitude: 34.105657, longitude: -118.348687, user_id: 15, trip_id: 10)
Ketchup.create!(start_date: DateTime.new(2020, 7, 25, 12, 00, 0), end_date: DateTime.new(2020, 7, 25, 13, 30, 0), message: 'Just chilling at the beach and we might get something to bite', location: 'Venice Beach', status: 'confirmed', latitude: 33.976975, longitude: -118.466388, user_id: 13, trip_id: 12)
Ketchup.create!(start_date: DateTime.new(2020, 7, 26, 15, 30, 0), end_date: DateTime.new(2020, 7, 26, 18, 45, 0), message: 'Hiking in the park with this Hungarian guy with mustache', location: 'Kenneth Hahn Lower Park', status: 'pending', latitude: 34.008955, longitude: -118.369431, user_id: 18, trip_id: 12)
Ketchup.create!(start_date: DateTime.new(2020, 9, 3, 18, 00, 0), end_date: DateTime.new(2020, 9, 3, 21, 00, 0), message: 'Let\'s catch up and some nice meat!', location: 'The Capital Grille - Curbside Takeout & Delivery', status: 'confirmed', latitude: 40.751155, longitude: -73.974895, user_id: 11, trip_id: 19)
Ketchup.create!(start_date: DateTime.new(2020, 9, 5, 12, 00, 0), end_date: DateTime.new(2020, 9, 5, 12, 30, 0), message: 'How about one more coffee?', location: 'Blue Bottle Coffee', status: 'pending', latitude: 40.753063, longitude: -73.984136, user_id: 11, trip_id: 19)
Ketchup.create!(start_date: DateTime.new(2020, 9, 9, 12, 00, 0), end_date: DateTime.new(2020, 9, 9, 17, 00, 0), message: 'Can you show me around the famous Statue of Liberty?', location: 'Statue of Liberty National Monument', status: 'confirmed', latitude: 40.689376, longitude: -74.044628, user_id: 11, trip_id: 20)
Ketchup.create!(start_date: DateTime.new(2020, 9, 12, 10, 30, 0), end_date: DateTime.new(2020, 9, 12, 11, 30, 0), message: 'Craving for some nice bagel and coffee!', location: 'Ess-a-Bagel', status: 'pending', latitude: 40.756193, longitude: -73.970294, user_id: 11, trip_id: 20)
Ketchup.create!(start_date: DateTime.new(2020, 9, 13, 21, 00, 0), end_date: DateTime.new(2020, 9, 14, 01, 00, 0), message: 'Want some good tapas and nice wine to enjoy the evening!', location: 'El Nacional', status: 'confirmed', latitude: 41.390207, longitude: 2.167891, user_id: 6, trip_id: 21)
Ketchup.create!(start_date: DateTime.new(2020, 9, 17, 16, 00, 0), end_date: DateTime.new(2020, 9, 17, 18, 00, 0), message: 'Need to do some shopping and can you help me?', location: 'L\'illa Diagonal', status: 'pending', latitude: 41.389829, longitude: 2.135075, user_id: 6, trip_id: 21)
Ketchup.create!(start_date: DateTime.new(2020, 9, 19, 22, 00, 0), end_date: DateTime.new(2020, 9, 20, 00, 00, 0), message: 'Wanna grab some beers and say hi?', location: '4 Latas - Muntaner', status: 'confirmed', latitude: 41.393401, longitude: 2.150272, user_id: 6, trip_id: 22)
Ketchup.create!(start_date: DateTime.new(2020, 9, 21, 20, 00, 0), end_date: DateTime.new(2020, 9, 21, 23, 30, 0), message: 'Can you take me to Barca match? Tickets are on me!', location: 'Camp Nou', status: 'pending', latitude: 41.380606, longitude: 2.123056, user_id: 6, trip_id: 22)
Ketchup.create!(start_date: DateTime.new(2020, 9, 23, 14, 00, 0), end_date: DateTime.new(2020, 9, 23, 18, 00, 0), message: 'Heard Giants are playing Dodgers! Wanna watch how Giants bit the shit out of Dodgers!', location: 'Dodger Stadium', status: 'confirmed', latitude: 34.073620, longitude: -118.239894, user_id: 14, trip_id: 23)
Ketchup.create!(start_date: DateTime.new(2020, 9, 27, 12, 00, 0), end_date: DateTime.new(2020, 9, 27, 15, 30, 0), message: 'Can you have a walk with me and show around? ', location: 'Hollywood Walk of Fame', status: 'pending', latitude: 34.101543, longitude: -118.326872, user_id: 14, trip_id: 23)
Ketchup.create!(start_date: DateTime.new(2020, 9, 30, 19, 00, 0), end_date: DateTime.new(2020, 9, 30, 22, 00, 0), message: 'J.Lo is coming to Staples Center. Can you please take me there?', location: 'STAPLES Center', status: 'confirmed', latitude: 34.042916, longitude: -118.267323, user_id: 14, trip_id: 24)
Ketchup.create!(start_date: DateTime.new(2020, 10, 1, 18, 00, 0), end_date: DateTime.new(2020, 10, 1, 20, 00, 0), message: 'Heard this place is quite nice! Want some Korean BBQ with me?', location: 'Dream Korean BBQ', status: 'pending', latitude: 34.073582, longitude: -118.308654, user_id: 14, trip_id: 24)
