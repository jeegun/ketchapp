...
Ketchup.create!(start_date: DateTime.new(2020, 4, 24, 15, 00, 0), end_date: DateTime.new(2020, 4, 24, 16, 00, 0), message: 'Enjoying the sun and walk on the beach', location: 'Platja del Bogatell', status: 'confirmed', latitude: 41.394380, longitude: 2.206989, user_id: 2, trip_id: 11)
Ketchup.create!(start_date: DateTime.new(2020, 4, 24, 18, 00, 0), end_date: DateTime.new(2020, 4, 24, 19, 30, 0), message: 'A hike in the park with my old friend', location: 'Runyon Canyon Park', status: 'confirmed', latitude: 34.105657, longitude: -118.348687, user_id: 15, trip_id: 10)
...
Ketchup.create!(start_date: DateTime.new(2020, 4, 26, 15, 30, 0), end_date: DateTime.new(2020, 4, 26, 18, 45, 0), message: 'Hiking in the park with this Hungarian guy with mustache', location: 'Kenneth Hahn Lower Park', status: 'confirmed', latitude: 34.008955, longitude: -118.369431, user_id: 18, trip_id: 12)
Ketchup.create!(start_date: DateTime.new(2020, 5, 3, 9, 00, 0), end_date: DateTime.new(2020, 5, 3, 11, 30, 0), message: 'Morning hike in the mountain located in the middle of Seoul with great view', location: 'Namsan Mountain Park', status: 'pending', latitude: 37.550815, longitude: 126.991211, user_id: 19, trip_id: 13)
Ketchup.create!(start_date: DateTime.new(2020, 5, 5, 16, 30, 0), end_date: DateTime.new(2020, 5, 5, 17, 00, 0), message: 'Quick afternoon coffee before my afternoon meeting in Brooklyn', location: 'Starbucks', status: 'pending', latitude: 40.748985, longitude: -73.992362, user_id: 10, trip_id: 14)
Ketchup.create!(start_date: DateTime.new(2020, 5, 8, 12, 30, 0), end_date: DateTime.new(2020, 5, 8, 13, 45, 0), message: 'Claire will be my guide to show me around one of the iconic place in the world', location: 'Times square', status: 'pending', latitude: 40.757970, longitude: -73.985549, user_id: 8, trip_id: 14)
Ketchup.create!(start_date: DateTime.new(2020, 5, 10, 18, 00, 0), end_date: DateTime.new(2020, 5, 10, 19, 30, 0), message: 'Short dinner to ketchup with my man', location: 'Maple Tree House', status: 'pending', latitude: 37.535047, longitude: 126.993882, user_id: 24, trip_id: 13)
Ketchup.create!(start_date: DateTime.new(2020, 5, 8, 19, 00, 0), end_date: DateTime.new(2020, 5, 8, 23, 00, 0), message: 'Long and relaxing dinner at a restaurant with superb view', location: 'Maiella', status: 'pending', latitude: 40.747190, longitude: -73.956690, user_id: 9, trip_id: 14)
Ketchup.create!(start_date: DateTime.new(2020, 5, 19, 12, 00, 0), end_date: DateTime.new(2020, 5, 19, 12, 30, 0), message: 'How about having a quick tea?', location: 'Osulloc Tea House', status: 'pending', latitude: 37.574223, longitude: 126.984372, user_id: 21, trip_id: 16)
Ketchup.create!(start_date: DateTime.new(2020, 5, 19, 19, 30, 0), end_date: DateTime.new(2020, 5, 19, 20, 30, 0), message: 'Let\'s do some picnic at the park with nice weather', location: 'Yeouido Hangang Park', status: 'pending', latitude: 37.528417, longitude: 126.934250, user_id: 20, trip_id: 16)
Ketchup.create!(start_date: DateTime.new(2020, 5, 21, 18, 00, 0), end_date: DateTime.new(2020, 5, 21, 20, 15, 0), message: 'Craving for some Korean meat! Vamos?', location: 'Gombawi', status: 'pending', latitude: 37.510203, longitude: 127.055203, user_id: 23, trip_id: 16)
