...
Notification.create!(recipient_id: 6, actor_id: 7, action: 'has accepted your', notifiable_id: 2, notifiable_type: 'FriendRequest')
Notification.create!(recipient_id: 6, actor_id: 16, action: 'has accepted your', notifiable_id: 4, notifiable_type: 'FriendRequest')
Notification.create!(recipient_id: 6, actor_id: 22, action: 'has accepted your', notifiable_id: 6, notifiable_type: 'FriendRequest')
Notification.create!(recipient_id: 11, actor_id: 4, action: 'has accepted your', notifiable_id: 8, notifiable_type: 'FriendRequest')
Notification.create!(recipient_id: 11, actor_id: 15, action: 'has accepted your', notifiable_id: 10, notifiable_type: 'FriendRequest')
Notification.create!(recipient_id: 11, actor_id: 23, action: 'has accepted your', notifiable_id: 12, notifiable_type: 'FriendRequest')
Notification.create!(recipient_id: 14, actor_id: 1, action: 'has accepted your', notifiable_id: 14, notifiable_type: 'FriendRequest')
Notification.create!(recipient_id: 14, actor_id: 10, action: 'has accepted your', notifiable_id: 16, notifiable_type: 'FriendRequest')
Notification.create!(recipient_id: 14, actor_id: 20, action: 'has accepted your', notifiable_id: 18, notifiable_type: 'FriendRequest')
